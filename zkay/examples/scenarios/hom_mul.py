...
sb.add_state_assertion('productPosNeg', expected_value=6, should_decrypt=True)
sb.add_state_assertion('productNegPos', expected_value=6, should_decrypt=True)
sb.add_state_assertion('productNegNeg', expected_value=-6, should_decrypt=True)
